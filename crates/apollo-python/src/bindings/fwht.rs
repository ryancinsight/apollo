...
#[pyfunction]
pub(crate) fn fwht1<'py>(py: Python<'py>, input: PyReadonlyArray1<f64>) -> PyResult<PyObject> {
...
#[pyfunction]
pub(crate) fn ifwht1<'py>(py: Python<'py>, input: PyReadonlyArray1<f64>) -> PyResult<PyObject> {
...
#[pyfunction]
pub(crate) fn fwht2<'py>(py: Python<'py>, input: PyReadonlyArray2<f64>) -> PyResult<PyObject> {
...
#[pyfunction]
pub(crate) fn ifwht2<'py>(py: Python<'py>, input: PyReadonlyArray2<f64>) -> PyResult<PyObject> {
...
#[pyfunction]
pub(crate) fn fwht3<'py>(py: Python<'py>, input: PyReadonlyArray3<f64>) -> PyResult<PyObject> {
...
#[pyfunction]
pub(crate) fn ifwht3<'py>(py: Python<'py>, input: PyReadonlyArray3<f64>) -> PyResult<PyObject> {
