...
use crate::application::execution::kernel::stockham::avx::{stage_triple64_groups_eight_avx_fma, stage_triple64_radix1_avx_fma, stage_triple32_radix1_avx_fma}; use super::butterfly::{stage_quad_impl, stage_pair_impl, stage_triple_impl, stockham_mixed_twiddle_32, stockham_mixed_twiddle_64, build_butterfly512_twiddles_32, build_butterfly512_twiddles_64, hybrid_radix8x512_64_avx_fma, hybrid_radix8x512_32_avx_fma};
use num_complex::{Complex32, Complex64};
    ...
    fn f64_hybrid_radix8x512_matches_stockham_n4096() {
        ...
        transform::transform::<F64StockhamAvxFma>(&mut expected, &mut expected_scratch, &twiddles, None);
        unsafe {
    ...
    fn f32_hybrid_radix8x512_matches_stockham_n4096() {
        ...
        transform::transform::<F32StockhamAvxFma>(&mut expected, &mut expected_scratch, &twiddles, None);
        unsafe {
