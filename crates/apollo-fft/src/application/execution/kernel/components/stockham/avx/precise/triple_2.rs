...
pub(crate) unsafe fn stage_triple_groups_eight_precise_avx_fma(
    ...
    for j in 0..radix {
        ...
        let t2 = cmul_vec_precise(_mm256_set1_pd(w2a.re), _mm256_set1_pd(w2a.im), s2);
        ...
        let t3 = cmul_vec_precise(_mm256_set1_pd(w2a.re), _mm256_set1_pd(w2a.im), s3);
        let p1 = _mm256_add_pd(s1, t3);
        let p5 = _mm256_sub_pd(s1, t3);

        let w3a = *third_ptr.add(j);
        let q0 = cmul_vec_precise(_mm256_set1_pd(w3a.re), _mm256_set1_pd(w3a.im), p1);
        ...
        let q2 = cmul_vec_precise(_mm256_set1_pd(w3c.re), _mm256_set1_pd(w3c.im), p5);
        _mm256_storeu_pd(
        ...
        let u2 = cmul_vec_precise(w2br, w2bi, d2);
        let u3 = cmul_vec_precise(w2br, w2bi, d3);
        ...
        let q1 = cmul_vec_precise(_mm256_set1_pd(w3b.re), _mm256_set1_pd(w3b.im), p3);
        _mm256_storeu_pd(
        ...
        let q3 = cmul_vec_precise(_mm256_set1_pd(w3d.re), _mm256_set1_pd(w3d.im), p7);
        _mm256_storeu_pd(
