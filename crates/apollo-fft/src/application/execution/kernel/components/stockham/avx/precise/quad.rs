...
pub(crate) unsafe fn stockham_quad_store_pair_precise(
    ...
    let product = cmul_vec_precise(_mm256_set1_pd(twiddle.re), _mm256_set1_pd(twiddle.im), odd);
    _mm_storeu_pd(
...
pub(crate) unsafe fn stockham_quad_groups_eight_precise_first_pairs(
    ...
    let t45 = cmul_vec_precise(w20r, w20i, y45);
    let t67 = cmul_vec_precise(w20r, w20i, y67);
    ...
    let u23 = cmul_vec_precise(w30r, w30i, z23);
    ...
    let u10_11 = cmul_vec_precise(w32r, w32i, z10_11);
...
pub(crate) unsafe fn stockham_quad_groups_eight_precise_second_pairs(
    ...
    let t12_13 = cmul_vec_precise(w21r, w21i, y12_13);
    let t14_15 = cmul_vec_precise(w21r, w21i, y14_15);
    ...
    let u67 = cmul_vec_precise(w31r, w31i, z67);
    ...
    let u14_15 = cmul_vec_precise(w33r, w33i, z14_15);
