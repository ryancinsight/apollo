...
pub(crate) unsafe fn stage_triple_quarter_groups_one_precise_avx_fma(
    src: &[Complex64],
    dst: &mut [Complex64],
    radix: usize,
    ...
    for j in 0..radix {
        ...
        let tw45 = cmul_vec_precise(w1r, w1i, v45);
        let tw67 = cmul_vec_precise(w1r, w1i, v67);
        ...
        let t23 = cmul_vec_precise(w2ar, w2ai, s23);

        let w2br = _mm256_set1_pd(w2b.re);
        let w2bi = _mm256_set1_pd(w2b.im);
        let u23 = cmul_vec_precise(w2br, w2bi, d23);
        ...
        let q01 = cmul_vec_precise(w3ab_r, w3ab_i, p13);
        ...
        let q23 = cmul_vec_precise(w3cd_r, w3cd_i, p57);
