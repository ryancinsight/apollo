...
//!
//! Test-time [`PRIMITIVE_ROOTS`] values are generated by `apollo-fft-macros`
//! from the same table used for static code generation.

use crate::application::execution::kernel::integer_math::{mod_pow, prime_factors_all};
