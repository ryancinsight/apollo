...
### Added
- [minor] Apollo now pins Leto/Leto Ops to pushed Leto `b9e11a8` (`0.14.0`), importing the provider-side eigenvalues-only symmetric Jacobi path for nalgebra-parity and eigensolver memory efficiency.
